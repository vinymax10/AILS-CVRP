...
public class InstanciaMatrizShort implements Instancia
{
	private int size;
...
//	private HashMap <Integer,Integer> hash;
	...
	public InstanciaMatrizShort(String nome,Config config,boolean rounded) 
	{
		this.nome=nome;
		this.config=config;
...
//				System.out.println();
	...
	public static void main(String[] args) 
	{
		...
		new InstanciaMatrizShort("Vrp-Set-XXL//Brussels2.vrp",config,true);
