...
public class InstanciaMatriz implements Instancia
{
	private int size;
	...
	public InstanciaMatriz(String nome,Config config,boolean rounded) 
	{
		this.nome=nome;
		this.config=config;
	...
	{
		if(size<=nLimiteDist||tipoEdgeType==TipoEdgeType.EXPLICIT)
			return dist[i][j];
		else if(i!=j)
		{
...
//				System.out.println();
	...
	public static void main(String[] args) 
	{
		...
		new InstanciaMatriz("Vrp-Set-XXL//Brussels2.vrp",config,true);
