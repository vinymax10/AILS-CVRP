...
public class InstanciaHash implements Instancia
{
	private int size;
...
//	private HashMap <Integer,Integer> hash;
	...
	public InstanciaHash(String nome,Config config,boolean rounded) 
	{
		this.nome=nome;
		this.config=config;
	...
	private void leituraCoord(BufferedReader in)
	{
		...
		if(tipoEdgeType==TipoEdgeType.EUC_2D)
		{
			...
			hash=new HashMap<Long,Short>(size*size);
...
//				System.out.println();
	...
	public static void main(String[] args) 
	{
		...
		new InstanciaHash("Vrp-Set-XXL//Brussels2.vrp",config,true);
		
//		int n=100;
//		boolean vet[]=new boolean [instancia.size];
//		int pos;
//		Random rand=new Random();
//		for (int i = 0; i < n; i++) 
//		{
//			pos=rand.nextInt(instancia.size);
//			while(vet[pos])
//				pos=rand.nextInt(instancia.size);
//			vet[pos]=true;
//		}
...
//		{
//			if(vet[i])
//				System.out.println((cont++)+"\t"+instancia.coord[i][0]+"\t"+instancia.coord[i][1]);
//		}
//		System.out.println("DEMAND_SECTION");
//		cont=1;
//		for (int i = 0; i < instancia.size; i++) 
//		{
//			if(vet[i])
//				System.out.println((cont++)+"\t"+instancia.pontos[i].demanda);
//		}
