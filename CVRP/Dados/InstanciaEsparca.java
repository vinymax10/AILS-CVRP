...
public class InstanciaEsparca implements Instancia
{
	private int size;
...
//	private HashMap <Integer,Integer> hash;
	...
	public InstanciaEsparca(String nome,Config config,boolean rounded) 
	{
		this.nome=nome;
		this.config=config;
		this.rounded=rounded;
		this.nLimiteDist=config.getnLimiteDist();
...
//				System.out.println();
	...
	public static void main(String[] args) 
	{
		...
		new InstanciaEsparca("Vrp-Set-XXL//Brussels2.vrp",config,true);
